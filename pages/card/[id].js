...
export default function Card() {
  return (
        <>
        <Head>
          <title>INFLUENCER SERIES: PELLEK | Chain Guardians</title>
        ...
        <div className="font-sans bg-body bg-no-repeat">
        <div className="card-bg rounded-lg w-full h-60 absolute bg-card bg-no-repeat filter saturate-0 opacity-10">
        </div>

          <Header />
          <div className="h-1 xs2:h-2 md:h-1 bg-violet-grad max-w-container mx-auto"></div>
            ...
            <section className="sm:grid sm:grid-cols-5 sm:grid-rows-5 lg:grid-rows-4 z-20 relative">
              ...
              <div className="sm:col-span-2 sm:row-span-5 lg:row-span-4 sm:mt-16 md:mt-0 2xl:pl-20 mt-6 xl:mt-12">
                <div className="inline-block w-8/12 xs:w-4/12 sm:w-full xl:w-max mb-5 py-3 ml-3 xl:py-8 border-2 border-aq-marin lg:overflow-visible mr-5">
                  <img src="/images/card-0002-xl.webp" className="-ml-3 mr-3 xl:-ml-10 xl:mr-10 w-full xs:w-9/12 sm:w-full xl:w-29 rounded-lg transform hover:scale-105 hover:-rotate-1 hover:shadow-lg transition duration-300" alt="" />
                </div>
              </div>
