        ...
        <div className="flex flex-col md:w-full pb-10 sm:mt-12 xl:mt-24">
          <div className="flex overflow-x-scroll hide-scroll-bar md:overflow-visible">
            <div className="flex flex-nowrap lg:w-full md:justify-between xl:justify-start">
              <Link href="/card/0001">
              <div className="inline-block overflow-hidden lg:overflow-visible mr-5 cursor-pointer transform hover:scale-105 hover:rotate-2 transition duration-300">
                <img src="/images/card-0001-xl.webp" className="max-w-xs w-28 xs2:w-40 md:w-40 lg:w-56 xl:w-17.5 rounded-lg" alt="" />
              </div>
              </Link>
              <Link href="/card/0002">
              <div className="inline-block overflow-hidden mr-5 cursor-pointer transform hover:scale-105 hover:rotate-2 transition duration-300">
              ...
              <Link href="/">
                <div className="hidden lg:block sm:w-32 md:w-40 lg:w-56 xl:w-17.5 inline-block border-dashed border-2 border-aq-marin text-center bg-black-0e lg:pt-36 xl:pt-48 cursor-pointer transform hover:scale-105 transition duration-300">
